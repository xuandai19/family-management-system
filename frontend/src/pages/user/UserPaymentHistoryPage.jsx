    ...
    const fetchPayments = async () => {
      ...
      try {
        ...
        const mockData = [
          {
            id: 1,
            description: "Quỹ tháng 12/2025",
            amount: 500000,
            paymentDate: "2025-12-15",
            method: "Chuyển khoản",
            status: "completed",
            receiptNo: "QUY-2025-120",
          },
          {
            id: 2,
            description: "Quỹ Tết Nguyên Đán 2026",
            amount: 1000000,
            paymentDate: "2026-01-10",
            method: "Tiền mặt",
            status: "completed",
            receiptNo: "QUY-2026-001",
          },
          {
            id: 3,
            description: "Quỹ tháng 11/2025",
            amount: 500000,
            paymentDate: "2025-11-20",
            method: "Chuyển khoản",
            status: "completed",
            receiptNo: "QUY-2025-110",
          },
          {
            id: 4,
            description: "Quỹ sửa chữa từ đường",
            amount: 2000000,
            paymentDate: "2025-10-05",
            method: "Chuyển khoản",
            status: "completed",
            receiptNo: "QUY-2025-100",
          },
        ];
