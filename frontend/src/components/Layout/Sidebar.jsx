          ...
          <div className="flex items-center gap-3">
            <span
              className={
                isActive
                  ? "text-white"
                  : "text-emerald-500/60 group-hover:text-emerald-600"
              }
            >
              {icon}
            </span>
  ...
  return (
    <div className="bg-white h-full border-r border-emerald-100 flex flex-col w-64 fixed left-0 top-0 overflow-y-auto z-50 shadow-lg text-left">
      ...
      <div className="h-24 flex flex-col items-center justify-center border-b border-emerald-50 mb-4 bg-white">
        <div className="flex items-center gap-2">
          ...
          <div className="text-left">
            <h1 className="text-emerald-800 font-black text-lg uppercase tracking-tighter leading-none">
              Gia Phả
            </h1>
            <h2 className="text-emerald-500 font-bold text-base uppercase leading-none mt-1">
              Đại Việt
            </h2>
          </div>
        </div>
      ...
      <div className="flex-1 px-4 py-2">
        {/* Nhóm 1: DÒNG HỌ */}
        <div className="mb-8">
          <p className="text-[10px] font-black text-emerald-800/40 mb-3 px-3 uppercase tracking-widest text-left">
            Dòng họ
          </p>
