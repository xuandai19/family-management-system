...
const MenuManagement = () => {
  ...
  const cardStyle =
    "bg-white rounded-xl shadow-sm border border-emerald-100 overflow-hidden transition-all";
    ...
    <div className="p-8 bg-[#f8fafc] min-h-screen font-sans text-left">
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="text-xs text-slate-400 font-medium italic">
          Website /{" "}
          <span className="text-emerald-600 font-bold">Quản lý Menu</span>
        </div>
      </div>
      ...
      <div className="bg-[#10b981] border-l-[12px] border-[#065f46] rounded-2xl p-6 mb-10 shadow-lg shadow-emerald-200/50">
        ...
        <div className="flex items-center justify-between">
          <label className="flex items-center gap-3 cursor-pointer group bg-[#065f46] px-5 py-2.5 rounded-xl border border-emerald-400/30 transition-all hover:bg-emerald-900">
            ...
            />
            <span className="text-xs font-black text-emerald-50 uppercase tracking-[0.1em]">
              KÍCH HOẠT HỆ THỐNG MENU
            </span>
          </label>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-4 space-y-4 text-left">
          <h3 className="font-black text-slate-400 text-[10px] uppercase tracking-[0.2em] mb-4 ml-2 italic text-left">
            Thêm mục điều hướng
          </h3>
          ...
          <div className={cardStyle}>
            ...
            >
              <div className="flex items-center gap-3">
                <Link size={16} className="text-emerald-500" /> Liên kết tự tạo
              </div>
            ...
            {openAccordion === "custom" && (
              <div className="p-6 bg-white border-t border-emerald-50 space-y-5 animate-in slide-in-from-top-2 duration-300">
                <div className="text-left">
                  <label className="block text-[10px] font-black uppercase text-slate-400 mb-2 ml-1 italic text-left">
                    URL
                  </label>
                  <input
                    type="text"
                    placeholder="https://..."
                    className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 outline-none focus:ring-2 focus:ring-emerald-500 text-sm font-medium"
                  />
                </div>
                <div className="text-left">
                  <label className="block text-[10px] font-black uppercase text-slate-400 mb-2 ml-1 italic text-left">
                  ...
                  <input
                    type="text"
                    className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 outline-none focus:ring-2 focus:ring-emerald-500 text-sm font-bold"
                  />
                </div>
        ...
        <div className="lg:col-span-8 text-left">
          <div className="flex justify-between items-end mb-4 px-2">
            <h3 className="font-black text-slate-400 text-[10px] uppercase tracking-[0.2em] italic text-left">
                ...
                <div className="bg-white border border-slate-200 flex-1 rounded-2xl px-6 py-4 flex justify-between items-center shadow-sm group-hover:border-emerald-400 group-hover:shadow-md transition-all cursor-move">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex flex-col text-left">
                      <span className="font-black text-slate-700 text-xs uppercase tracking-tight text-left">
                        {item.name}
                      </span>
                  ...
                  <div className="flex items-center gap-5">
                    <span className="px-2 py-0.5 bg-slate-100 text-[9px] font-black uppercase text-slate-400 rounded-md italic">
                      {item.type}
                    </span>
                    <Settings
                      size={16}
                      className="text-slate-300 cursor-pointer hover:text-emerald-600 transition-colors"
                    />
                  </div>
                </div>
