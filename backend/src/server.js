...
app.use("/api/family", (await import("./routes/member/familyRoutes.js")).default);
...
app.use("/api/collections", (await import("./routes/admin/collectionRoutes.js")).default);
app.use("/api/ancestral-house", (await import("./routes/admin/ancestralHouseRoutes.js")).default);
app.use("/api/posts", (await import("./routes/admin/postRoutes.js")).default);
app.use("/api/notifications", (await import("./routes/admin/notifiRoutes.js")).default);
app.use("/api/dashboard", (await import("./routes/admin/dashboardRoutes.js")).default);
